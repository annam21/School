...
\subsection{Sec 1.8 Problem 12}\label{sec-1.8-problem-12}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ppl <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{33}\NormalTok{) )}
...
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{nsim)\{}
  \CommentTok{# Select 1 team}
\NormalTok{  team1 <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(ppl, }\DecValTok{10}\NormalTok{)}
  
  \CommentTok{# Are both people on that team or the other team? }
\NormalTok{  out[i] <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(team1) }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{2}\NormalTok{)}
\NormalTok{\}}

\CommentTok{# Estimated probability}
\KeywordTok{sum}\NormalTok{(out)}\OperatorTok{/}\KeywordTok{length}\NormalTok{(out)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{choose}\NormalTok{(}\DecValTok{33}\NormalTok{, }\DecValTok{23}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{choose}\NormalTok{(}\DecValTok{33}\NormalTok{, }\DecValTok{8}\NormalTok{))}\OperatorTok{/}\KeywordTok{choose}\NormalTok{(}\DecValTok{35}\NormalTok{, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
